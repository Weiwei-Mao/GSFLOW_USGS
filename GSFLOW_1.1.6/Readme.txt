...
GSFLOW version 1.1.6 is packaged for personal computers using one of the 
...
It is recommended that no user files are kept in the GSFLOW_1.1.6 directory
structure.  If you do plan to put your own files in the GSFLOW_1.1.6
directory structure, do so only by creating additional subdirectories of
the GSFLOW_1.1.6\data subdirectory.

Included in directory GSFLOW_1.1.6\doc\GSFLOW is the GSFLOW documentation 
...
directory, the directory containing the executable (GSFLOW_1.1.6\bin)
...
As an alternative, the executable files in the GSFLOW_1.1.6\bin directory 
...
in the GSFLOW_1.1.6\bin directory. After the GSFLOW_1.1.6\bin directory is
...
located in directory GSFLOW_1.1.6\data\sagehen.


E. COMPILING

The executable file provided in GSFLOW_1.1.6\bin was created using the Intel
...
the GSFLOW_1.1.6\src directory so that GSFLOW can be recompiled if
...
in the GSFLOW_1.1.6\src directories as an example for compiling GSFLOW.
